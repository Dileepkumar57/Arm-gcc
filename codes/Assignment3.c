...
PyHal_GPIO_SetDir(15,0); //Input
PyHal_GPIO_SetDir(16,0); //Input
...
b = 0;
c = ((!A)&(!B)&(!X)&(!Y))|((!A)&B&X&(!Y))|(A&(!B)&(!X)&(!Y))|(A&(!B)&Y)|(A&B&X&(!Y))|(A&B&(!X)&Y);
d = a;
e = ((!A)&(!B)&X)|((!A)&B&(!X))|((!A)&B&X&Y)|(A&B&(!X)&(!Y))|(A&B&X&Y);
f = ((!A)&(!B)&(!X)&(!Y))|((!A)&(!B)&X)|(A&(!B)&(!X))|(A&(!B)&X&Y)|B;
g = ((!A)&(!B)&(!X)&Y)|((!A)&(!B)&X&Y)|((!A)&B&(!X))|(A&(!B)&X&(!Y));
